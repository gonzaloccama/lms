							...
							<div class="row">
								...
								<div class="col-md-4">
									<input type="text" class="form-control" id="first_parent"
										   ...
										   name="first_parent" value="<?= set_value("first_parent"); ?>">
								</div>
								<div class="col-md-4">
									<input type="text" class="form-control" id="last_parent"
										   placeholder="Apellido Materno"
										   name="last_parent" value="<?= set_value("last_parent"); ?>">
								</div>
							</div>
							<?= form_error("name",
									"<p class='text-danger m-1' style='font-size: 13px;'>
							...
							<div class="col text-center my-2">
								<div class="ml-2">
									<img src="https://placehold.it/80x80" id="preview_thumbnail"
										 class="avatar-img avatar-xxl rounded-circle" alt="avatar"
