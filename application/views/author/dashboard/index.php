...
<div class="row container-fluid page__container">
	<div class="card card-header card-header-large shadow pt-4 pb-0">
		<div id="cards-left" class="card-group-row">
			<div class="card col-md-3 bg-secondary">
				<div class="card-body media">
					<div class="media-body text-center">
						<span class="material-icons fa-3x text-white">inventory_2</span>
						<h6 class="pt-3 text-white"><?= $num_courses ?></h6>
						<p class="text-white mb-0">NÚMERO DE CURSOS</p>
					</div>
				</div>
			</div>
			...
			<div class="card col-md-3 bg-secondary">
				<div class="card-body media">
					<div class="media-body text-center">
						<span class="material-icons fa-3x text-white">supervised_user_circle</span>
						<h6 class="pt-3 text-white">5</h6>
						<p class="text-white mb-0">NÚMERO DE REGISTRADOS</p>
					</div>
				</div>
			</div>
			...
			<div class="card col-md-3 bg-secondary">
				<div class="card-body media">
					<div class="media-body text-center">
						<span class="material-icons fa-3x text-white">widgets</span>
						<h6 class="pt-3 text-white"><?= $num_courses - $status ?></h6>
						<p class="text-white mb-0">CURSOS PENDIENTES</p>
					</div>
				</div>
			</div>
			...
			<div class="card col-md-3 bg-secondary">
				<div class="card-body media">
					<div class="media-body text-center">
						<span class="material-icons fa-3x text-white">mark_chat_read</span>
						<h6 class="pt-3 text-white"><?= $status ?></h6>
						<p class="text-white mb-0">CURSOS ACTIVOS</p>
					</div>
				</div>
			</div>
		</div>
...
<div class="row container-fluid page__container">
	<div class="card card-header card-header-large shadow">
		<div class="card-group-row">
			<div class="col-lg-6">
				<div class="card">
					<div class="card-header d-flex card-header-large bg-secondary align-items-center">
						<div class="mr-3">
							<i class="material-icons icon-30pt text-muted-light">receipt</i>
						</div>
						<div class="flex">
							<h4 class="card-header__title text-white">Registros</h4>
							<div class="card-subtitle text-white">Registros recientes</div>
						</div>
						<div class="ml-auto">
			...
			<div class="col-lg-6">
				<div class="card">
					<div class="card-header card-header-large bg-secondary d-flex align-items-center">
						<div class="mr-3">
							<i class="material-icons icon-30pt text-muted-light">forum</i>
						</div>
						<div class="flex">
							<h4 class="card-header__title text-white">Comentarios</h4>
							<div class="card-subtitle text-white">Comentarios recientes</div>
						</div>
						<div class="ml-auto">
					...
					<div class="card-body">
						...
						<div class="media ml-sm-32pt border rounded p-3 bg-light">
							...
							<div class="media-body">
								...
								<p class="mt-1 mb-0 text-black-70">Hi John,<br> Lorem ipsum dolor! <br><br>Lorem ipsum
									dolor
									sit
								...
								<div class="input-group-append">
									<div class="input-group-text pr-2">
										<button class="btn btn-flush" type="button"><i
													class="material-icons">tag_faces</i>
										</button>
									</div>
									...
									<div class="input-group-text pl-0">
										<button class="btn btn-flush" type="button"><i class="material-icons">send</i>
										</button>
									</div>
								</div>
							</div>
