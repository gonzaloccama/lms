...
class Student extends CI_Controller
{
    ...
    function index()
    {
		...
		$data['info'] = array(
			'page_title' => 'Administrador - Estudiante',
			'title' => 'Estudiante',
			'sub_title' => 'Estudiantes',
			'active' => 5,
	...
	public function add()
	{
		...
		if ($this->form_validation->run() == FALSE) :
			...
			redirect(base_url() . 'admin/student', 'location');
		endif;
	}
